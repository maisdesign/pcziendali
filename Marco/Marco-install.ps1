# ============================================================================
# PC MARCO - Install Script
# Windows 11 Pro - Dev Workstation
# ============================================================================
...
Write-Host "║          INSTALLAZIONE SOFTWARE - PC MARCO (DEV)              ║" -ForegroundColor Green
Write-Host "╚════════════════════════════════════════════════════════════════╝" -ForegroundColor Green
Write-Host ""
...
Write-Host "2. Abilita Hyper-V per Docker:" -ForegroundColor Cyan
Write-Host "   Enable-WindowsOptionalFeature -Online -FeatureName Hyper-V -All"
Write-Host ""
